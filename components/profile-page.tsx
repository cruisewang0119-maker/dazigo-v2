...
export default function ProfilePage() {
  ...
  return (
    <div className="flex flex-col min-h-full pb-8 overflow-y-auto">
      ...
      <div className="px-5 mb-6">
        <h3 className="text-sm font-medium text-foreground mb-3">Taste profile</h3>
        <div className="bg-card rounded-2xl border border-border p-5">
          ...
          <div className="mt-4 p-4 rounded-xl bg-[#FFF5F5] border border-[#FF6B6B]/15">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs font-medium text-[#FF6B6B]">AI insight</span>
            </div>
      ...
      <div className="px-5 mb-6">
        <h3 className="text-sm font-medium text-foreground mb-3">My tags</h3>
      ...
      <div className="px-5 mb-6">
        <div className="flex items-center justify-between mb-3">
          <h3 className="text-sm font-medium text-foreground">My buddies</h3>
